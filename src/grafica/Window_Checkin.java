 ...
 */
public class Window_Checkin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnCheckIn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/ui/ui_btnCheckIn.png"))); // NOI18N
        ...
        btnCheckIn.setBounds(280, 190, 190, 38);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Window_Checkin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Window_Checkin().setVisible(true);
            }
        });
    }
