...
public class Tools_Ocupacion extends javax.swing.JPanel {
    ...
    public void build() {
            ...
            this.setSize(450, 80);
            centerElements();
            if (Index.user.getNombre().equals("root")){
                cmbVisualizar.setModel(new DefaultComboBoxModel<>(new String[] {"Día"}));
            }else if(Index.user.getNombre().equals("Duenno")){
                cmbVisualizar.setModel(new DefaultComboBoxModel<>(new String[] {"Día","Semana","Mes"}));
            }
    }

    public void centerElements() {
        int startingWidth = this.getWidth() - btnVisualizar.getWidth() - cmbVisualizar.getWidth() - lblVisualizar.getWidth()*2 + 20;
